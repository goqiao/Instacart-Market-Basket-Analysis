...
parser = argparse.ArgumentParser('run xgb choose sample size and num trees')
# add paramters
...
if __name__ == '__main__':
    ...
    up[['order_id', 'products']].to_csv('data/my_submission_up_only_faron_{}_{}.csv'.format(args.sample_frac,
                                                                                            args.n_estimators), index=False)
