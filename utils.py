...
def keep_top_features(df, keep_high_mid_fi=True, keep_high_fi=False):
    ...
    p_middle = ['p_purchase_interval_days_std', 'p_is_organic', 'p_std_add_cart_num', 'p_std_first_order_num', 'p_avg_first_order_num',
                'p_std_first_reorder_diff', 'p_num_purchases_per_user_max', 'p_avg_first_reorder_num']
    ...
    user_high = ['user_days_not_purchase', 'user_total_orders',
                 'user_next_order_readiness', 'user_age_days_on_platform', 'user_mean_days_order_interval',
                 'uo_reordered_products_mean', 'uo_reorder_ratio_mean', 'user_product_unique', 'user_reorder_rate',
    ...
    up_high = ['up_num_purchases_r5', 'up_reorder_tendency_proba_r5', 'up_purchase_ratio_r5', 'up_reorder_tendency_proba', 'num_orders_not_purchase',
               'up_num_purchases_diff_p_q20', 'up_purchase_interval_days_max_r5',
               'up_overdue_days_diff_max_vs_self', 'up_overdue_days_diff_mean_vs_self', 'up_num_purchases', 'up_overdue_days_diff_min_vs_others',
               'up_overdue_days_diff_q20_vs_others', 'up_num_days_not_purchase', 'up_first_order', 'up_overdue_days_diff_min_vs_self', 'up_aisle_purchase_skew',
               'up_num_purchases_diff_p_mean', 'up_overdue_days_diff_median_vs_others', 'up_std_order_num', 'up_num_purchases_diff_p_q80', 'up_overdue_days_diff_q80_vs_others',
               'up_purchase_interval_days_min_r5', 'up_overdue_days_diff_max_vs_others', 'up_cart_order_median', 'up_overdue_days_percent_range_vs_others',
               'up_purchase_interval_days_median', 'up_overdue_days_percent_range_vs_self', 'up_purchase_interval_days_median_r5', 'up_purchase_interval_days_max',
               'up_cart_order_mean', 'up_mean_order_num', 'up_purchase_interval_days_mean']
    up_middle = ['up_cart_order_sum', 'up_purchase_interval_days_min', 'up_purchases_pod_morning',
    ...
    product_embedding = ['p_embedding_0', 'p_embedding_1', 'p_embedding_2',
       'p_embedding_3', 'p_embedding_4', 'p_embedding_5', 'p_embedding_6',
       'p_embedding_7', 'p_embedding_8', 'p_embedding_9', 'p_embedding_10',
       'p_embedding_11', 'p_embedding_12', 'p_embedding_13', 'p_embedding_14',
       'p_embedding_15', 'p_embedding_16', 'p_embedding_17', 'p_embedding_18',
       'p_embedding_19', 'p_embedding_20', 'p_embedding_21', 'p_embedding_22',
       'p_embedding_23', 'p_embedding_24', 'p_embedding_25', 'p_embedding_26',
       'p_embedding_27', 'p_embedding_28', 'p_embedding_29', 'p_embedding_30',
       'p_embedding_31', 'p_embedding_32', 'p_embedding_33', 'p_embedding_34',
       'p_embedding_35', 'p_embedding_36', 'p_embedding_37', 'p_embedding_38',
       'p_embedding_39']
    ...
    if keep_high_mid_fi:
        ...
        to_keep = p_high + p_middle + user_high + user_middle + up_high + up_middle + product_embedding
    elif keep_high_fi:
