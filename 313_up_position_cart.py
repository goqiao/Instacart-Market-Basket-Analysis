...
_up = (
    prior_order_details_r5.groupby(["user_id", "product_id"])
    .agg(
        {
...
_up.columns = [
    "user_id",
    "product_id",
    "_up_cart_order_mean_r5",
    "_up_cart_order_std_r5",
    "_up_cart_order_sum_r5",
    "_up_cart_order_min_r5",
    "_up_cart_order_max_r5",
    "_up_cart_order_median_r5",
]


# merge with base
base_up = pd.read_pickle("{}/base.pickle".format(data_folder))[
    ["user_id", "product_id"]
]
