...
users_basket_trend = orders.groupby('user_id').agg({'num_products': [trend_d1, skew]}).reset_index()
users_basket_trend.columns = ['user_id', 'user_basket_size_trend_d1', 'user_basket_size_skew']
