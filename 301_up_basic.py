...
_up = prior_order_details.groupby(["user_id", "product_id"]).agg(
    {
        "order_id": "count",
...
up_agg = _up.rename(
    columns={
        "order_id_count": "up_num_purchases",
        "add_to_cart_order_std": "up_cart_order_std",
        "add_to_cart_order_sum": "up_cart_order_sum",
        "add_to_cart_order_min": "up_cart_order_min",
        "add_to_cart_order_max": "up_cart_order_max",
        "add_to_cart_order_median": "up_cart_order_median",
