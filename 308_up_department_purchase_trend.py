...
users_departments_trend = users_departments.groupby(['user_id', 'department']).agg({'num_products': ['mean', trend_d1, skewness]}).reset_index()

users_departments_trend.columns = ['user_id', 'department',  'up_mean_prods_same_department_per_order', 'up_department_purchase_trend_d1', 'up_department_purchase_skew']
...
users_departments_trend[['user_id', 'product_id', 'up_mean_prods_same_department_per_order', 'up_department_purchase_trend_d1', 'up_department_purchase_skew']].to_pickle(
