...
first_order = prior_order_details.loc[prior_order_details['reordered'] == 0].groupby(['product_id', 'user_id']).agg({'order_number': 'min'})
first_reorder = prior_order_details.loc[prior_order_details['reordered'] == 1].groupby(['product_id', 'user_id']).agg({'order_number': 'min'})
...
first_reorder_diff.columns = first_reorder_diff.columns.get_level_values(0) + '_' + first_reorder_diff.columns.get_level_values(1)
...
p_first_reorder.columns = p_first_reorder.columns.get_level_values(0) + '_' + p_first_reorder.columns.get_level_values(1)
