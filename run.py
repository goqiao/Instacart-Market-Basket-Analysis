...
os.system('python 102_users_purchase_interval_trend.py')
os.system('python 103_users_basket_size_trend.py')
os.system('python 104_users_order_time.py')
os.system('python 105_users_organic_purchases.py')


### 2xx create product level features
os.system('python 201_product_basic.py')
os.system('python 202_product_cycles.py')
os.system('python 203_product_purchases.py')
