...
fi = pd.read_csv('data/up_feature_importance_all.csv') # data is sorted with most important features at top
...
# output top and mid featuers as list
...
with open('data/selected_top_gain_features.pickle', 'wb') as f:
