...
"""
use results of word2vec algorithm to find the most similar (substitute) products for each item. 
...
if __name__ == "__main__":
    ...
    res[["product_id", "substitute_id"]] = res[["product_id", "substitute_id"]].astype(
        "int"
    )
